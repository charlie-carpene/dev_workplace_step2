...
class CountriesTest < ApplicationSystemTestCase
  ...
  test "creating a Country" do
    ...
    fill_in "Id", with: @country.id
    fill_in "Iso 2", with: @country.iso_2
    fill_in "Iso 3", with: @country.iso_3
    fill_in "Name en", with: @country.name_en
    fill_in "Name fr", with: @country.name_fr
